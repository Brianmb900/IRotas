        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                <div class="col" style="margin-top: 20px;">
                    ...
                    <% }%>
                    <b style="font-size: 30px; margin-left: 15px;">Meu Auto Escola</b>
                </div>
            </div>
            <hr>
            <div class="row justify-content-center">
                <div class="col">
                    <form autocomplete="off" method="POST">
                        ...
                        <input class="form-control" type="hidden" name="adm" value="">
                        <input class="form-control" type="text" name="nome" id="nome" value="" placeholder="Nome" disabled>
                        <br><br>
                        <input class="form-control" type="email" name="e-mail" id="e-mail" value="" placeholder="Email" disabled>
                        <br><br>
                        <input class="form-control" type="text" name="phone" id="phone" value=""  placeholder="Telefone Ex: (xx)xxxxx-xxxx"
                               pattern="[(]{1}[0-9]{2}[)]{1}[0-9]{5}[-]{1}[0-9]{4}"
                               title="Núemro do telefone celular Ex: (xx)xxxxx-xxxx" disabled>
                        <br><br>
                        <input class="form-control" type="text" name="endereco" id="endereco" value="" placeholder="endereço" disabled>
                        </div>
                        <div class="col">
                            <input class="form-control" type="text" name="bairro" id="bairro" value="" placeholder="bairro" disabled>
                            <br><br>
                            <div class="row">
                                <div class="col">
                                    <input class="form-control" type="text" name="ciade" id="cidade" value="" placeholder="cidade" disabled>
                                </div>
                            </div>
                            <br><br>
                            <input class="form-control" type="text" name="cep" id="cep" value=""  placeholder="CEP"
                                   pattern="[(]{1}[0-9]{2}[)]{1}[0-9]{5}[-]{1}[0-9]{4}"
                                   title="Núemro do telefone celular Ex: (xx)xxxxx-xxxx" disabled>
                        </div>
